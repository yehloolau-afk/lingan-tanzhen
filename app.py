...
MOCKUP_SPEC = (
    ...
    "手机外框：width:300px; flex-shrink:0; border-radius:10px; overflow:hidden;\n"
    "  border:2px solid #1A1A1A; background:#FFF;\n\n"
    "屏幕内容区（严格比例，9:19.5）：\n"
    "  background:#F2F2F7; width:296px（300 - 2×2 border）\n"
    "  height:641px（296 × 19.5/9 = 641px，严格固定）\n"
    ...
    "卡片：background:#FFF; border-radius:10px; box-shadow:0 1px 4px rgba(0,0,0,0.08); padding:14px 16px; margin:0 14px 10px;\n"
    "列表行：min-height:50px; padding:0 18px; display:flex; align-items:center; background:#FFF;\n"
    "  border-bottom:1px solid #F5F5F5; 文字font-size:17px color:#000; 右侧chevron › color:#C7C7CC font-size:16px\n"
    "  列表组之间用：height:10px; background:#F5F5F5; 作为分组间隔\n"
    "Tag/徽标：display:inline-block; background:rgba(主色,0.1); color:主色;\n"
    "  border-radius:5px; padding:3px 10px; font-size:13px; font-weight:500;\n"
    "  【禁止】border-style:dashed 或任何虚线/描边边框\n"
    "主按钮：display:block; background:主色; color:#FFF; border-radius:14px;\n"
    "  height:56px; line-height:56px; font-size:19px; font-weight:600; text-align:center;\n"
    "  margin:0 18px; letter-spacing:0.5px;\n"
    "次按钮：border:1.5px solid 主色; color:主色; background:#FFF; border-radius:14px;\n"
    "  height:48px; line-height:46px; font-size:17px; text-align:center; margin:0 18px;\n"
    "输入框：background:#F5F5F5; border-radius:10px; border:none; padding:12px 16px; font-size:17px; color:#000;\n"
    "文字层次：大标题24px/700 color:#000; 正文17px/400 color:#000; 辅助14px/400 color:#8C8C8C\n"
    "Tab Bar：height:56px; flex-shrink:0; background:#FFF; border-top:0.5px solid #F0F0F0;\n"
    "  display:flex; 每项：flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center;\n"
    "  emoji font-size:22px; 文字font-size:11px; active color:主色; inactive color:#8C8C8C\n\n"
